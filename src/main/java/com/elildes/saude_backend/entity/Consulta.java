...
public class Consulta {
    ...
    public String toString() {
        return "Consulta [id_consulta=" + id_consulta + ", paciente=" + paciente + ", profissional=" + profissional
                + ", data=" + data + ", horario=" + horario + ", clinica=" + clinica + ", getId_consulta()="
                + getId_consulta() + ", getPaciente()=" + getPaciente() + ", getClass()=" + getClass()
                + ", getProfissional()=" + getProfissional() + ", getData()=" + getData() + ", getHorario()="
                + getHorario() + ", getClinica()=" + getClinica() + ", hashCode()=" + hashCode() + ", toString()="
                + super.toString() + "]";
    }
